...
public class HighlightRemovalTest : MonoBehaviour {
	...
	private const bool doJitter = true;
	private const bool staggeredJitter = true;
	...
	private readonly int[][] offsets = new int[][] { new int[] { 0, 0 }, new int[] { 1, 0 }, new int[] { 1, 1 }, new int[] { 0, 1 }, };
