  ...
  public class ClusteringRTsAndBuffers {
    ...
    public void SetDeterministicClusterCenters() {
      for (int i = 0; i < this.numClusters; i++) {
        ...
        this.clusterCentersTempData[i] = new Vector4(c.r, c.g, Mathf.Infinity,
          0); // "new"
        this.clusterCentersTempData[i + this.numClusters] = new Vector4(c.r, c.g,
    ...
    public void SetFakeValidClusterCenters() {
      for (int i = 0; i < this.numClusters; i++) {
        ...
        // variance infinity to ensure new cluster centers will replace these ones
        this.clusterCentersTempData[i] = new Vector4(c.r, c.g, 0.1f,
          0); // "new"
        this.clusterCentersTempData[i + this.numClusters] = new Vector4(c.r, c.g,
          0.1f, 0); // "old"
      }
    ...
    public void Downsample(
      ...
      if (staggeredJitter) {
        ...
        this.scanlinePixelOffset[0] =
          Time.frameCount % this.jitterSize;
      ...
      csHighlightRemoval.SetTexture(
        kernelSubsample, "tex_input",
        this.texturesFullRes.rtInput
      );

      csHighlightRemoval.SetTexture(
        kernelSubsample, "tex_output",
