...
{
    public class DispatcherKHMp : ASimpleDispatcer
    {
        [Serializable]
        public class Parameters : DispatcherParameters
        {
            ...
            /// <summary>
            /// Default value of <see cref="Parameters.p"/> is 2.5, which we experimentally confirmed to be optimal for our dataset (<see cref="BenchmarkGeneration.KHMp"/>). For values above p=3.0 we saw a sharp decline in quality for one of the video files.<para />
